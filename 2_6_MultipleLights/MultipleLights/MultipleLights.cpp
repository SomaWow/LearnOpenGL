...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//点光源
		lightingShader.setVec3("poingLights[0].position", pointLightPositions[0]);
		...
		lightingShader.setVec3("poingLights[1].position", pointLightPositions[1]);
		...
		lightingShader.setVec3("poingLights[2].position", pointLightPositions[2]);
		...
		lightingShader.setVec3("poingLights[3].position", pointLightPositions[3]);
