	...
	: PostProcessingShader(shader), Texture(), Width(width), Height(height), Confuse(GL_FALSE), Chaos(GL_FALSE), Shake(GL_FALSE)
{
	...
	this->Texture.Generate(width, height, NULL, 0);
...
void PostProcessor::Render(GLfloat time) 
{
	...
	this->PostProcessingShader.setFloat("chaos", this->Chaos);
	this->PostProcessingShader.setFloat("shake", this->Shake);
