...
int main() {
	...
	// -------------------------
	//爆炸shader
	Shader explosionShader("explosion_shader.vs", "explosion_shader.fs", "explosion_shader.gs");
	//长毛shader
	...
	// load models
	// -----------
	Model nanosuit((char*)"D:/File/OpenGL/4_9_GeometryShader/4_9_GeometryShader/resources/objects/nanosuit/nanosuit.obj");
