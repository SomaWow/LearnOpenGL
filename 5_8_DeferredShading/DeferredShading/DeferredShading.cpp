...
int main() {
	...
	Model nanosuit((char*)"D:/File/OpenGL/5_8_DeferredShading/DeferredShading/nanosuit/nanosuit.obj");
	std::vector<glm::vec3> objectPositions; //纳米战士的位置
